  ...
  return (
    <div>
      <h2 id="customer-heading">
        <Translate contentKey="demoApp.customer.home.title">Customers</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="demoApp.customer.home.createLabel">Create new Customer</Translate>
        </Link>
      </h2>
        ...
        {customerList && customerList.length > 0 ? (
            ...
            <tbody>
              {customerList.map((customer, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>
                    {customer.updateDate ? <TextFormat type="date" value={customer.updateDate} format={APP_LOCAL_DATE_FORMAT} /> : null}
                  </td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="demoApp.customer.home.notFound">No Customers found</Translate>
            </div>
          )
        )}
      </div>
